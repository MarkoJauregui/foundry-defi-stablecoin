...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice You will get a liquidation bonus to pay the user's debt.
     * @notice This function working assumes the protocol will be roughly 200% overcollateralized to work.
     * @notice A bug would be if the protocol were 100% or less collateralized. We wouldn't be able to incetive liquidators.
     */
        ...
        nonReentrant
    {
        ...
        // And give the liquidator a 10% bonus incentive.
